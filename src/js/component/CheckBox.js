...
const CB_ENABLED_IMAGE = require('../../res/imgs/check_box_1.png');
const CB_DISABLED_IMAGE = require('../../res/imgs/check_box_0.png');
...
class CheckBox extends Component {
    ...
    render() {
                ...
                <View style={this.props.containerStyle || [styles.container, styles.flexContainer]}>
                    {(this.props.label ? (
                        <View style={styles.labelContainer}
                            ...
                            <Text numberOfLines={this.props.labelLines}
                                  style={[styles.label, this.props.labelStyle]}>{this.props.label}</Text>
                        </View>
                    ) : <View/>)}
                    <Image
        ...
        return (
            <TouchableHighlight accessible={this.props.accessible} accessibilityLabel={this.props.accessibilityLabel}
                                testID={this.props.testID} onPress={this.onChange}
                                underlayColor={this.props.underlayColor} style={[styles.flexContainer, this.props.style]}
